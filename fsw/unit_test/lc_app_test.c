...
int32  LC_APP_TEST_CFE_TBL_RegisterHook1(CFE_TBL_Handle_t *TblHandlePtr, const char *Name, uint32 Size,
...
int32 LC_APP_TEST_CFE_TBL_RegisterHook2(CFE_TBL_Handle_t *TblHandlePtr, const char *Name, uint32 Size,
                                        uint16 TblOptionFlags, CFE_TBL_CallbackFuncPtr_t TblValidationFuncPtr)
{
    LC_APP_TEST_CFE_TBL_RegisterHookCount++;
...
int32 LC_APP_TEST_CFE_TBL_RegisterHook3(CFE_TBL_Handle_t *TblHandlePtr, const char *Name, uint32 Size,
                                        uint16 TblOptionFlags, CFE_TBL_CallbackFuncPtr_t TblValidationFuncPtr)
{
    LC_APP_TEST_CFE_TBL_RegisterHookCount++;
...
int32 LC_APP_TEST_CFE_TBL_RegisterHook4(CFE_TBL_Handle_t *TblHandlePtr, const char *Name, uint32 Size,
                                        uint16 TblOptionFlags, CFE_TBL_CallbackFuncPtr_t TblValidationFuncPtr)
{
    LC_APP_TEST_CFE_TBL_RegisterHookCount++;
