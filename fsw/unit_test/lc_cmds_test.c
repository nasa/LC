...
void LC_AppPipe_Test_Noop(void)
{
     ...
     * has been reached */
    UtAssert_True(Ut_CFE_EVS_EventSent(LC_NOOP_INF_EID, CFE_EVS_INFORMATION, "No-op command: Version 2.1.0.0"),
...
void LC_AppPipe_Test_Reset(void)
{
    ...
    /* Note: this event message is generated in a subfunction, but is tested anyway to verify that the correct code path
     * has been reached */
    UtAssert_True(Ut_CFE_EVS_EventSent(LC_RESET_DBG_EID, CFE_EVS_DEBUG, "Reset counters command"),
...
void LC_AppPipe_Test_InvalidCommandCode(void)
{
    ...
    UtAssert_True(Ut_CFE_EVS_EventSent(LC_CC_ERR_EID, CFE_EVS_ERROR, "Invalid command code: ID = 0x18A4, CC = 99"),
...
void LC_SampleAPReq_Test_ArrayIndexOutOfRange(void)
{
    ...
    /* Verify results */
    UtAssert_True(Ut_CFE_EVS_EventSent(LC_APSAMPLE_APNUM_ERR_EID, CFE_EVS_ERROR,
...
void LC_SetLCStateCmd_Test_Active(void)
{
    ...
    UtAssert_True(Ut_CFE_EVS_EventSent(LC_LCSTATE_INF_EID, CFE_EVS_INFORMATION, "Set LC state command: new state = 1"),
...
void LC_SetLCStateCmd_Test_Passive(void)
{
    ...
    UtAssert_True(Ut_CFE_EVS_EventSent(LC_LCSTATE_INF_EID, CFE_EVS_INFORMATION, "Set LC state command: new state = 2"),
...
void LC_SetLCStateCmd_Test_Disabled(void)
{
    ...
    UtAssert_True(Ut_CFE_EVS_EventSent(LC_LCSTATE_INF_EID, CFE_EVS_INFORMATION, "Set LC state command: new state = 3"),
...
void LC_SetLCStateCmd_Test_Default(void)
{
    ...
    UtAssert_True(Ut_CFE_EVS_EventSent(LC_LCSTATE_ERR_EID, CFE_EVS_ERROR, "Set LC state error: invalid state = 99"),
...
void LC_SetAPStateCmd_Test_Default(void)
{
    ...
    UtAssert_True(Ut_CFE_EVS_EventSent(LC_APSTATE_NEW_ERR_EID, CFE_EVS_ERROR,
...
void LC_SetAPStateCmd_Test_SetAllActionPointsActive(void)
{
    ...
    UtAssert_True(Ut_CFE_EVS_EventSent(LC_APSTATE_INF_EID, CFE_EVS_INFORMATION,
...
void LC_SetAPStateCmd_Test_InvalidCurrentAPStateActive(void)
{
    ...
    UtAssert_True(Ut_CFE_EVS_EventSent(LC_APSTATE_CURR_ERR_EID, CFE_EVS_ERROR,
...
void LC_SetAPPermOffCmd_Test_APNotDisabled(void)
{
    ...
    UtAssert_True(Ut_CFE_EVS_EventSent(LC_APOFF_CURR_ERR_EID, CFE_EVS_ERROR,
...
void LC_SetAPPermOffCmd_Test_Nominal(void)
{
    ...
    UtAssert_True(Ut_CFE_EVS_EventSent(LC_APOFF_INF_EID, CFE_EVS_INFORMATION, "Set AP permanently off command: AP = 1"),
...
void LC_ResetAPStatsCmd_Test_AllActionPoints(void)
{
    ...
    UtAssert_True(Ut_CFE_EVS_EventSent(LC_APSTATS_INF_EID, CFE_EVS_INFORMATION, "Reset AP stats command: AP = 65535"),
...
void LC_ResetAPStatsCmd_Test_SingleActionPoint(void)
{
    ...
    UtAssert_True(Ut_CFE_EVS_EventSent(LC_APSTATS_INF_EID, CFE_EVS_INFORMATION, "Reset AP stats command: AP = 175"),
...
void LC_ResetWPStatsCmd_Test_AllWatchPoints(void)
{
    ...
    UtAssert_True(Ut_CFE_EVS_EventSent(LC_WPSTATS_INF_EID, CFE_EVS_INFORMATION, "Reset WP stats command: WP = 65535"),
...
void LC_ResetWPStatsCmd_Test_SingleWatchPoint(void)
{
    ...
    UtAssert_True(Ut_CFE_EVS_EventSent(LC_WPSTATS_INF_EID, CFE_EVS_INFORMATION, "Reset WP stats command: WP = 175"),
...
void LC_VerifyMsgLength_Test_GenericLengthError(void)
{
    ...
    UtAssert_True(Ut_CFE_EVS_EventSent(LC_LEN_ERR_EID, CFE_EVS_ERROR,
...
void LC_UpdateTaskCDS_Test_UpdateWatchpointError(void)
{
    ...
    UtAssert_True(Ut_CFE_EVS_EventSent(LC_WRT_NO_SAVE_ERR_EID, CFE_EVS_ERROR,
...
void LC_UpdateTaskCDS_Test_UpdateActionpointError(void)
{
    ...
    UtAssert_True(Ut_CFE_EVS_EventSent(LC_ART_NO_SAVE_ERR_EID, CFE_EVS_ERROR,
...
void LC_UpdateTaskCDS_Test_UpdateAppDataError(void)
{
    ...
    UtAssert_True(Ut_CFE_EVS_EventSent(LC_APP_NO_SAVE_START_ERR_EID, CFE_EVS_ERROR,
...
void LC_Cmds_Test_AddTestCases(void)
{
    ...
    UtTest_Add(LC_HousekeepingReq_Test_UpdateTaskCDSNotSuccess, LC_Test_Setup, LC_Test_TearDown,
