PROC $sc_$cpu_lc_evtfilter
;*******************************************************************************
;  Test Name:  lc_evtfilter
...
;   LC3002	For each table-defined Actionpoint, LC shall store the results
...
;       lc_adt5       Sets up the Actionpoint Definition table files for testing
;
...
local cfe_requirements[0 .. ut_req_array_size] = ["LC_1003","LC_3001", ;;
   "LC_3001.2","LC_3002","LC_3002.1","LC_3002.1.1","LC_3002.2", ;;
   "LC_3002.2.1","LC_3002.3","LC_3002.3.1","LC_3002.4","LC_3006", ;;
   "LC_4000","LC_8000","LC_9000","LC_9001","LC_9002"] 
...
s ftp_file(defaultTblDir, "lc_def_adt5.tbl", adtFileName, hostCPU, "P")
...
write "  Cum Event Msgs Sent    = ", $SC_$CPU_LC_ART[5].CumulativeMsgsSent
write " "
...
write "  Cum Event Msgs Sent    = ", $SC_$CPU_LC_ART[6].CumulativeMsgsSent
write " "
...
write "  Cum Event Msgs Sent    = ", $SC_$CPU_LC_ART[9].CumulativeMsgsSent
write " "

;; Check the Cumulative Message Counters (3006.h)
if (p@$SC_$CPU_LC_ART[5].CumulativeMsgsSent = ap5EvtCtr) then
  write "<*> Passed (3006.h) - AP 5 Cumulative Message Counter as expected."
  ut_setrequirements LC_3006, "P"
else
  write "<!> Failed (3006.h) - AP 5 Cumulative Message Counter incorrect. Expected ",ap5EvtCtr," Got ",$SC_$CPU_LC_ART[5].CumulativeMsgsSent
  ut_setrequirements LC_3006, "F"
  ap5EvtCtr = $SC_$CPU_LC_ART[5].CumulativeMsgsSent
endif

if (p@$SC_$CPU_LC_ART[6].CumulativeMsgsSent = ap6EvtCtr) then
  write "<*> Passed (3006.h) - AP 6 Cumulative Message Counter as expected."
  ut_setrequirements LC_3006, "P"
else
  write "<!> Failed (3006.h) - AP 6 Cumulative Message Counter incorrect. Expected ",ap6EvtCtr," Got ",$SC_$CPU_LC_ART[6].CumulativeMsgsSent
  ut_setrequirements LC_3006, "F"
  ap6EvtCtr = $SC_$CPU_LC_ART[6].CumulativeMsgsSent
endif

if (p@$SC_$CPU_LC_ART[9].CumulativeMsgsSent = ap9EvtCtr) then
  write "<*> Passed (3006.h) - AP 9 Cumulative Message Counter as expected."
  ut_setrequirements LC_3006, "P"
else
  write "<!> Failed (3006.h) - AP 9 Cumulative Message Counter incorrect. Expected ",ap9EvtCtr," Got ",$SC_$CPU_LC_ART[9].CumulativeMsgsSent
  ut_setrequirements LC_3006, "F"
  ap9EvtCtr = $SC_$CPU_LC_ART[9].CumulativeMsgsSent
endif
...
s $sc_$cpu_lc_sendpackets("2.5",2)
...
;; The Global counter should increment when AP 9 is sampled
write " LC Passive RTS Count = ", $SC_$CPU_LC_PassRTSCnt
...
ut_tlmupdate $SC_$CPU_LC_PassRTSCnt

;; Verify the counter incremented
write " LC Passive RTS Count = ", $SC_$CPU_LC_PassRTSCnt
if ($SC_$CPU_LC_PassRTSCnt = expectedPassRTSCnt) THEN
  write "<*> Passed (3002.4) - Passive RTS Counter incremented correctly."
  ut_setrequirements LC_30024, "P"
else
  write "<!> Failed (3002.4) - Passive RTS Counter did not increment as expected. Got ",$SC_$CPU_LC_PassRTSCnt,"; Expected ",expectedPassRTSCnt
  ut_setrequirements LC_30024, "F"
endif
...
;; Increment the expected message counters
ap5EvtCtr = ap5EvtCtr + 1
ap6EvtCtr = ap6EvtCtr + 1
ap9EvtCtr = ap9EvtCtr + 1
...
s $sc_$cpu_lc_sendpackets("2.8",3)
...
s $sc_$cpu_lc_sendpackets("2.11",4)
...
s $sc_$cpu_lc_sendpackets("2.14",1)
...
;; Verify the global counter increments
expectedPassRTSCnt = $SC_$CPU_LC_PassRTSCnt + 1
...
s $sc_$cpu_lc_sendpackets("2.17",2)
...
s $sc_$cpu_lc_sendpackets("2.20",3)
...
s $sc_$cpu_lc_sendpackets("2.23",4)
...
s $sc_$cpu_lc_sendpackets("2.26",1)
...
write ";*********************************************************************"
write ";  End procedure $SC_$CPU_lc_evtfilter"
write ";*********************************************************************"
ENDPROC
