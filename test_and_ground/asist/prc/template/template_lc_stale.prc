...
;		event message
;    LC2001	For each Watchpoint specified in the Watchpoint Definition Table
;		(WDT), LC shall specify an age value when the data becomes
;		"stale".
;    LC2002	For each Watchpoint specified in the Watchpoint Definition Table
;		(WDT), LC shall maintain the age of the data.
...
;       lc_wdt5      Sets up the Watchpoint Definition table file for testing
;       lc_adt6      Sets up the Actionpoint Definition table file for testing
;
...
local cfe_requirements[0 .. ut_req_array_size] = ["LC_1003","LC_2001", ;;
    "LC_2002","LC_2004","LC_3001","LC_3002","LC_3006","LC_4000", ;;
...
s ftp_file(defaultTblDir, "lc_def_wdt5.tbl", wdtFileName, hostCPU, "P")
...
s ftp_file(defaultTblDir, "lc_def_adt6.tbl", adtFileName, hostCPU, "P")
...
write ";*********************************************************************"
write ";  End procedure $SC_$CPU_lc_stale"
write ";*********************************************************************"
ENDPROC
