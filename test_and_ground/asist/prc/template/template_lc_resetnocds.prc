PROC $sc_$cpu_lc_resetnocds
;*******************************************************************************
;  Test Name:  lc_resetnocds
...
;                 g) The cumulative count of the RTS executions
;                 h) Total number of event messages sent
;   LC9003	Upon a cFE Processor Reset or LC Application Reset, if the
;		<PLATFORM_DEFINED> Save Critical Data parameter is set to NO, 
;		LC shall perform the same initialization as a cFE Power-on
;		(see LC9000, LC9001 and LC9002)
...
local cfe_requirements[0 .. ut_req_array_size] = ["LC_2004","LC_3006", ;;
    "LC_8000","LC_9000","LC_9001","LC_9002","LC_9003","LC_9005", ;;
    "LC_9006","LC_9007"]
...
write ";*********************************************************************"
write ";  End procedure $SC_$CPU_lc_resetnocds"
write ";*********************************************************************"
ENDPROC
