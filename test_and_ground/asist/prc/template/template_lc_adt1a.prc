...
;      5/10/17          W. Moleski      Updated to use CPU1 for commanding and
...
s create_tbl_file_from_cvt(hostCPU,appid,"ADTTable1a","lc_def_adt1a.tbl",ADTTblName,startMnemonic,endMnemonic)

write ";*********************************************************************"
write ";  End procedure $SC_$CPU_lc_adt1a"
write ";*********************************************************************"
ENDPROC
