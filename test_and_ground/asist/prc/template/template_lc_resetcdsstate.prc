...
local cfe_requirements[0 .. ut_req_array_size] = ["LC_1003","LC_4000", ;;
    "LC_8000","LC_9000","LC_9001","LC_9002","LC_9004.1","LC_9005", ;;
    "LC_9006","LC_9007","LC_9007.2"]
...
if (CDSGood = "Yes") then
  if (LC_STATE_WHEN_CDS_RESTORED = LC_STATE_FROM_CDS) then
    ...
    expectedState = LC_STATE_WHEN_CDS_RESTORED
  endif

  if ($SC_$CPU_LC_CURLCSTATE = expectedState) then
    write "<*> Passed (9004.1) - LC Application State initialized properly from CDS."
    ut_setrequirements LC_90041, "P"
  else
    write "<!> Failed (9004.1) - LC Application State NOT set properly in CDS. Expected ",expectedState,". State = ",$SC_$CPU_LC_CURLCSTATE
    ut_setrequirements LC_90041, "F"
  endif
else
  write "<!> Failed (9004.1) - LC Application State NOT set properly after Application Reset because CDS was not properly restored. Expected ",expectedState,". State = ",$SC_$CPU_LC_CURLCSTATE
    ut_setrequirements LC_90041, "F"
endif
...
write ";*********************************************************************"
write ";  End procedure $SC_$CPU_lc_resetcdsstate"
write ";*********************************************************************"
ENDPROC
