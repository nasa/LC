...
int32 LC_APP_TEST_CFE_TBL_RegisterHook1(CFE_TBL_Handle_t *TblHandlePtr, const char *Name, uint32  Size, uint16
...
int32 LC_APP_TEST_CFE_TBL_RegisterHook2(CFE_TBL_Handle_t *TblHandlePtr, const char *Name, uint32  Size, uint16
TblOptionFlags, CFE_TBL_CallbackFuncPtr_t TblValidationFuncPtr)
{
    LC_APP_TEST_CFE_TBL_RegisterHookCount++;
...
int32 LC_APP_TEST_CFE_TBL_RegisterHook3(CFE_TBL_Handle_t *TblHandlePtr, const char *Name, uint32  Size, uint16
TblOptionFlags, CFE_TBL_CallbackFuncPtr_t TblValidationFuncPtr)
{
    LC_APP_TEST_CFE_TBL_RegisterHookCount++;
...
int32 LC_APP_TEST_CFE_TBL_RegisterHook4(CFE_TBL_Handle_t *TblHandlePtr, const char *Name, uint32  Size, uint16
TblOptionFlags, CFE_TBL_CallbackFuncPtr_t TblValidationFuncPtr)
{
    LC_APP_TEST_CFE_TBL_RegisterHookCount++;
...
void LC_AppMain_Test_AppInitError(void)
{
    ...
    /* Verify results */
    UtAssert_True(Ut_CFE_EVS_EventSent(LC_TASK_EXIT_EID, CFE_EVS_CRITICAL, "Task terminating, err = 0xFFFFFFFF"),
                  "Task terminating, err = 0xFFFFFFFF");

    UtAssert_True(Ut_CFE_ES_SysLogWritten("LC task terminating, err = 0xFFFFFFFF\n"),
...
void LC_EvsInit_Test_EVSRegisterError(void)
{
    ...
    UtAssert_True(Ut_CFE_ES_SysLogWritten("LC App: Error Registering For Event Services, RC = 0xFFFFFFFF\n"),
...
void LC_SbInit_Test_CreatePipeError(void)
{
    ...
    /* Verify results */
    UtAssert_True(Ut_CFE_EVS_EventSent(LC_CR_PIPE_ERR_EID, CFE_EVS_ERROR, "Error Creating LC Pipe, RC=0xFFFFFFFF"),
...
void LC_SbInit_Test_SubscribeHKReqError(void)
{
    ...
    /* Verify results */
    UtAssert_True(Ut_CFE_EVS_EventSent(LC_SUB_HK_REQ_ERR_EID, CFE_EVS_ERROR,
...
void LC_SbInit_Test_SubscribeGndCmdError(void)
{
    ...
    /* Verify results */
    UtAssert_True(Ut_CFE_EVS_EventSent(LC_SUB_GND_CMD_ERR_EID, CFE_EVS_ERROR,
...
void LC_SbInit_Test_SubscribeSampleCmdError(void)
{
    ...
    /* Verify results */
    UtAssert_True(Ut_CFE_EVS_EventSent(LC_SUB_SAMPLE_CMD_ERR_EID, CFE_EVS_ERROR,
...
void LC_CreateResultTables_Test_WRTRegisterError(void)
{
    ...
    /* Verify results */
    UtAssert_True(Ut_CFE_EVS_EventSent(LC_WRT_REGISTER_ERR_EID, CFE_EVS_ERROR, "Error registering WRT, RC=0xFFFFFFFF"),
...
void LC_CreateResultTables_Test_ARTRegisterError(void)
{
    ...
    /* Verify results */
    UtAssert_True(Ut_CFE_EVS_EventSent(LC_ART_REGISTER_ERR_EID, CFE_EVS_ERROR, "Error registering ART, RC=0xFFFFFFFF"),
...
void LC_CreateDefinitionTables_Test_WDTRegisterError(void)
{
    ...
    /* Verify results */
    UtAssert_True(Result == -1, "Result == -1");
    UtAssert_True(Ut_CFE_EVS_EventSent(LC_WDT_REGISTER_ERR_EID, CFE_EVS_ERROR, "Error registering WDT, RC=0xFFFFFFFF"),
...
void LC_CreateDefinitionTables_Test_ADTRegisterError(void)
{
    ...
    /* Verify results */
    UtAssert_True(Result == -1, "Result == -1");
    UtAssert_True(Ut_CFE_EVS_EventSent(LC_ADT_REGISTER_ERR_EID, CFE_EVS_ERROR, "Error registering ADT, RC=0xFFFFFFFF"),
...
void LC_CreateTaskCDS_Test_NominalPowerOnReset(void)
{
    ...
    /* Verify results */
    UtAssert_True(Result == CFE_SUCCESS, "Result == CFE_SUCCESS");
    UtAssert_True(LC_OperData.TableResults == (LC_WRT_CDS_CREATED | LC_ART_CDS_CREATED | LC_APP_CDS_CREATED),
...
void LC_CreateTaskCDS_Test_NominalProcessorReset(void)
{
    ...
    // FIXME: This depends on a preprocessor constant value having a different value than default.  The comparison is
    // not done with a #if - should it?
    //    UtAssert_True(LC_AppData.CurrentLCState == LC_STATE_WHEN_CDS_RESTORED, "LC_AppData.CurrentLCState ==
...
void LC_CreateTaskCDS_Test_WRTRegisterCDSError(void)
{
    ...
    UtAssert_True(Ut_CFE_EVS_EventSent(LC_WRT_CDS_REGISTER_ERR_EID, CFE_EVS_ERROR,
...
void LC_CreateTaskCDS_Test_ARTRegisterCDSError(void)
{
    ...
    UtAssert_True(Ut_CFE_EVS_EventSent(LC_ART_CDS_REGISTER_ERR_EID, CFE_EVS_ERROR,
...
void LC_CreateTaskCDS_Test_AppDataRegisterCDSError(void)
{
    ...
    /* Verify results */
    UtAssert_True(Result == -1, "Result == -1");
    UtAssert_True(LC_OperData.TableResults == (LC_WRT_CDS_CREATED | LC_ART_CDS_CREATED),
                  "LC_OperData.TableResults == (LC_WRT_CDS_CREATED | LC_ART_CDS_CREATED)");

    UtAssert_True(Ut_CFE_EVS_EventSent(LC_APP_CDS_REGISTER_ERR_EID, CFE_EVS_ERROR,
...
void LC_LoadDefaultTables_Test_LoadWDTError(void)
{
    ...
    /* Verify results */
    UtAssert_True(Ut_CFE_EVS_EventSent(LC_WDT_LOAD_ERR_EID, CFE_EVS_ERROR,
...
void LC_LoadDefaultTables_Test_LoadADTError(void)
{
    ...
    /* Verify results */
    UtAssert_True(Ut_CFE_EVS_EventSent(LC_ADT_LOAD_ERR_EID, CFE_EVS_ERROR,
...
void LC_TableInit_Test_CreateResultTablesError(void)
{
    ...
    /* Set to make subfunction LC_CreateResultTables return -1, in order to satisfy condition "Result =
     * LC_CreateResultTables()) != CFE_SUCCESS" */
    Ut_CFE_TBL_SetReturnCode(UT_CFE_TBL_REGISTER_INDEX, -1, 1);
...
void LC_TableInit_Test_CreateDefinitionTablesError(void)
{
    ...
    /* Set to make subfunction LC_CreateDefinitionTables return -1, in order to satisfy condition "Result =
     * LC_CreateDefinitionTables()) != CFE_SUCCESS" */
...
void LC_TableInit_Test_LoadDefaultTables(void)
{
    ...
    /* Set to make subfunction LC_LoadDefaultTables return -1, in order to satisfy condition "Result =
     * LC_LoadDefaultTables()) != CFE_SUCCESS" */
    Ut_CFE_TBL_SetReturnCode(UT_CFE_TBL_LOAD_INDEX, -1, 1);
...
void LC_TableInit_Test_GetWDTAddressError(void)
{
    ...
    LC_OperData.TableResults =
        LC_WRT_CDS_RESTORED | LC_ART_CDS_RESTORED | LC_APP_CDS_RESTORED | LC_WDT_TBL_RESTORED | LC_ADT_TBL_RESTORED;
...
void LC_TableInit_Test_CDSRestored(void)
{
    ...
    UtAssert_True(Ut_CFE_EVS_EventSent(LC_CDS_RESTORED_INF_EID, CFE_EVS_INFORMATION,
...
void LC_TableInit_Test_CDSUpdated(void)
{
    ...
    UtAssert_True(Ut_CFE_EVS_EventSent(LC_CDS_UPDATED_INF_EID, CFE_EVS_INFORMATION,
...
void LC_TableInit_Test_NeitherRestoredNorUpdated(void)
{
    ...
    UtAssert_True(Ut_CFE_EVS_EventSent(LC_CDS_DISABLED_INF_EID, CFE_EVS_INFORMATION,
...
void LC_App_Test_AddTestCases(void)
{
    ...
    UtTest_Add(LC_TableInit_Test_CreateResultTablesError, LC_Test_Setup, LC_Test_TearDown,
               "LC_TableInit_Test_CreateResultTablesError");
    ...
    UtTest_Add(LC_CreateTaskCDS_Test_NominalPowerOnReset, LC_Test_Setup, LC_Test_TearDown,
               "LC_CreateTaskCDS_Test_NominalPowerOnReset");
    UtTest_Add(LC_CreateTaskCDS_Test_NominalProcessorReset, LC_Test_Setup, LC_Test_TearDown,
               "LC_CreateTaskCDS_Test_NominalProcessorReset"); // FIXME: need #if statement around this?  Depends on a
                                                               // DCR.  Currently skips a line.
