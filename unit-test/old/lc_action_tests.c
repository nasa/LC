...
void LC_SampleAPs_Test_SingleActionPointError(void)
{
    ...
    /* Verify results */
    UtAssert_True(Ut_CFE_EVS_EventSent(LC_APSAMPLE_CURR_ERR_EID, CFE_EVS_ERROR,
...
void LC_SampleSingleAP_Test_StateChangePassToFail(void)
{
    ...
    UtAssert_True(Ut_CFE_EVS_EventSent(LC_AP_PASSTOFAIL_INF_EID, CFE_EVS_INFORMATION,
...
void LC_SampleSingleAP_Test_ActiveRequestRTS(void)
{
    ...
    UtAssert_True(Ut_CFE_EVS_EventSent(LC_OperData.ADTPtr[APNumber].EventID, LC_OperData.ADTPtr[APNumber].EventType,
...
void LC_SampleSingleAP_Test_APFailWhileLCStatePassive(void)
{
    ...
    UtAssert_True(Ut_CFE_EVS_EventSent(LC_PASSIVE_FAIL_DBG_EID, CFE_EVS_DEBUG,
...
void LC_SampleSingleAP_Test_APFailWhilePassive(void)
{
    ...
    UtAssert_True(LC_OperData.ARTPtr[APNumber].CumulativeEventMsgsSent == 1,
                  "LC_OperData.ARTPtr[APNumber].CumulativeEventMsgsSent == 1");
    UtAssert_True(Ut_CFE_EVS_EventSent(LC_AP_PASSIVE_FAIL_INF_EID, CFE_EVS_INFORMATION,
...
void LC_SampleSingleAP_Test_StateChangeFailToPass(void)
{
    ...
    UtAssert_True(Ut_CFE_EVS_EventSent(LC_AP_FAILTOPASS_INF_EID, CFE_EVS_INFORMATION,
...
void LC_ValidateADT_Test_ActionNotUsed(void)
{
    ...
    UtAssert_True(Ut_CFE_EVS_EventSent(LC_ADTVAL_INF_EID, CFE_EVS_INFORMATION,
...
void LC_ValidateADT_Test_ValidateRpnAdtValError(void)
{
    ...
    UtAssert_True(Ut_CFE_EVS_EventSent(LC_ADTVAL_RPNERR_EID, CFE_EVS_ERROR,
