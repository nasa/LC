...
void LC_CreateHashTable_Test_UnsubscribeError(void)
{
    ...
    /* Verify results */
    UtAssert_True(Ut_CFE_EVS_EventSent(LC_UNSUB_WP_ERR_EID, CFE_EVS_ERROR,
...
void LC_AddWatchpoint_Test_NullPointersErrorSubscribingWatchpoint(void)
{
    ...
    /* Verify results */
    UtAssert_True(Ut_CFE_EVS_EventSent(LC_SUB_WP_ERR_EID, CFE_EVS_ERROR,
...
void LC_ProcessWP_Test_CustomFunctionWatchFalse(void)
{
     ...
     * has been reached */
    UtAssert_True(Ut_CFE_EVS_EventSent(LC_CFCALL_ERR_EID, CFE_EVS_ERROR, "Unexpected LC_CustomFunction call: WP = 0"),
...
void LC_OperatorCompare_Test_DataTypeError(void)
{
    ...
    UtAssert_True(Ut_CFE_EVS_EventSent(LC_WP_DATATYPE_ERR_EID, CFE_EVS_ERROR,
...
void LC_FloatCompare_Test_NaN(void)
{
    ...
    UtAssert_True(Ut_CFE_EVS_EventSent(LC_WP_NAN_ERR_EID, CFE_EVS_ERROR,
...
void LC_ValidateWDT_Test_UnusedTableEntry(void)
{
    ...
    UtAssert_True(Ut_CFE_EVS_EventSent(LC_WDTVAL_INF_EID, CFE_EVS_INFORMATION,
...
void LC_ValidateWDT_Test_InvalidDataType(void)
{
    ...
    UtAssert_True(Ut_CFE_EVS_EventSent(LC_WDTVAL_ERR_EID, CFE_EVS_ERROR,
...
void LC_ValidateWDT_Test_NaN(void)
{
    ...
    UtAssert_True(Ut_CFE_EVS_EventSent(LC_WDTVAL_FPERR_EID, CFE_EVS_ERROR,
